...
import edu.mirea.onebeattrue.samsunghack.presentation.auth.phone.PhoneStore.Intent
import edu.mirea.onebeattrue.samsunghack.presentation.auth.phone.PhoneStore.Label
import edu.mirea.onebeattrue.samsunghack.presentation.auth.phone.PhoneStore.State
            ...
            when (intent) {
                ...
                is Intent.SendCode -> {
                    if (isValidPhoneNumber(intent.phone)) {
                        ...
                        scope.launch {
                            authRepository.createUserWithPhone(
